...
notebook writes submissions under \texttt{results/submissions/} and benchmark
tables under \texttt{results/benchmarks/}.  The script is
...
The notebook writes the same CTMC files to \texttt{results/submissions/}, along
with tabular Random Forest and XGBoost submissions. Benchmark tables are written
to \texttt{results/benchmarks/}.
